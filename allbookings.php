		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				<ul class="radius-top clearfix" id="main-menu">
					...
					<li>
						<a class="active" href="allbookings.php">
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editbooking.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['transactionum'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
				...
				<div id="footer" class="radius-bottom">
					<a class="afooter-link " href="printbooking.php">Print</a>
				</div>
				<div class="clearfix"></div>
			</div>
			<div class="clearfix"></div>
