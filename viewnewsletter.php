		...
		<div id="panel-outer" class="radius" style="opacity: 1;">
			<div id="panel" class="radius">
				<ul class="radius-top clearfix" id="main-menu">
					...
					<li>
						<a class="active" href="viewnewsletter.php">
							...
							while($row = mysql_fetch_array($result))
								{
									...
									echo '<td><div align="center"><a rel="facebox" href="editnewsletter.php?id='.$row['id'].'">edit</a> | <a href="#" id="'.$row['id'].'" class="delbutton" title="Click To Delete">delete</a></div></td>';
									echo '</tr>';
								}
							?> 
						</tbody>
