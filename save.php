...
while($row = mysql_fetch_array($result))
	...
	$payable=$qty*$price;
mysql_query("INSERT INTO booking_customer (fname, lname, address, contact, boat, transactionum, payable, setnumber)
VALUES ('$fname', '$lname', '$address', '$contact', '$busnum', '$confirmation','$payable','$setnum')");
mysql_query("INSERT INTO reserve (date, boat, seat_reserve, transactionnum, seat)
